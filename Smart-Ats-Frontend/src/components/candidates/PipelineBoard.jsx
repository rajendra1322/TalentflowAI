              ...
              {candidates
                ...
                .map((candidate) => (
                  ...
                  >
                    ...
                    <div className="mt-2">
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${candidate.matchScore >= 80
                    ...
                    <div className="mt-3">
                      <select
                        className={`w-full border border-slate-200 rounded-lg p-2 text-sm ${!canEdit ? "cursor-not-allowed opacity-70" : ""
                          }`}
